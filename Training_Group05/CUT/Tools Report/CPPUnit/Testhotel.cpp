...
Testhotel::testinit(void)
{
  ...
  //  CPPUNIT_ASSERT(1 == mTestObj1->init("users.csv"));
   // CPPUNIT_ASSERT(1 == mTestObj1->init("users1.csv"));
...
Testhotel::testreserveRoom(void)
{
    ...
    CPPUNIT_ASSERT(false == mTestObj1->reserveRoom(300));
    CPPUNIT_ASSERT(false == mTestObj1->reserveRoom(400));
    CPPUNIT_ASSERT(false == mTestObj1->reserveRoom(500));
...
Testhotel::testunreserveRoom(void)
{
    ...
    CPPUNIT_ASSERT(true == mTestObj1->unreserveRoom(102));
    CPPUNIT_ASSERT(true == mTestObj1->unreserveRoom(103));
    CPPUNIT_ASSERT(true == mTestObj1->unreserveRoom(104));

    //rainy testcases
    CPPUNIT_ASSERT(false == mTestObj1->unreserveRoom(200));
    CPPUNIT_ASSERT(false == mTestObj1->unreserveRoom(124));
    CPPUNIT_ASSERT(false == mTestObj1->unreserveRoom(144));
    CPPUNIT_ASSERT(false == mTestObj1->unreserveRoom(114));
}
void
Testhotel::testAvailableRoom(void)
{
    ...
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoom("Non AC"));
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoom("Deluxe Suite"));
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoom("Executive Suite"));
...
Testhotel::testAvailableRoomWithPrice(void)
{
    ...
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoomWithPrice("Non AC",3));
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoomWithPrice("Deluxe Suite",3));
    CPPUNIT_ASSERT(true == mTestObj1->getAvailableRoomWithPrice("Executive Suuite",3));
